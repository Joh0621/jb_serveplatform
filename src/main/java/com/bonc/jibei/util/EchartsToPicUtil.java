...
public class EchartsToPicUtil {
	...
	public static String generateEChart(String options, String tmpPath , String OSType) {
		String rootPaht = EchartsToPicUtil.class.getResource("/").toString().replace("file:/", "");
		String echartJsPath = rootPaht  + "echarts-convert" + File.separator + "echarts-convert1.js";
		...
		try {
			...
			String cmd = rootPaht  + "phantomjs" + File.separator + OSPath + File.separator + "phantomjs " + echartJsPath + " -infile " + dataPath
					+ " -outfile " + path;
			log.info("shell " + cmd);
